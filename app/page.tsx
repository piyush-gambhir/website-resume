...
export default async function Home() {
    return (
        <main className="text-black mx-auto max-w-[40rem]">
            <Header />
            <main className="flex flex-col px-4">
                <section className="pb-16">
                    ...
                    <p className="text-lg text-black/70">
                        ...
                        web applications and solving complex problems. I have
                        experience in developing full-stack applications using
                        modern technologies.
                    </p>
                </section>
                <ProjectsSection />
